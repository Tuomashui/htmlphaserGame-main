...
})({"9rPTM":[function(require,module,exports) {
...
brick.src = "./js/assets/brick.png";
const pinecone = new Image();
pinecone.src = "./js/assets/pinecone.png";
const centipede = new Image();
centipede.src = "./js/assets/centipede.png";
let game;
const gameOptions = {
    centipedeGravity: 1,
    centipedeSpeed: 300
...
class PlayGame extends Phaser.Scene {
    preload() {
        ...
        this.load.image("cone", "pinecone");
        this.load.spritesheet("centipede", "./js/assets/centipede.png", {
            frameWidth: 50,
            frameHeight: 50
        });
    }
...
},{}]},["9rPTM","cMznl"], "cMznl", "parcelRequirefbf5")
